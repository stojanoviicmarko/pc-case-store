...
import { removeFromBasket } from '../store/products/product.actions'
          ...
          return (
            <div key={index} className="checkout__product">
              ...
              <div className="checkout__product__info">
                ...
                <p className="checkout__product__description">
                  {i.description}
                </p>
              </div>
              <div className="checkout__product__wrapper">
                ...
                <button
                  ...
                  className="checkout__remove__button"
                >
                  Remove
                </button>
              </div>
